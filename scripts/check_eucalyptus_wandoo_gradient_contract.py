...
def main() -> None:
    ...
    print("ML015 Eucalyptus wandoo gradient contract: PASS; 3 Fisher-z gradient effects retained with positive-definite residual-proxy V; primary Hedges-g denominator remains 3 clusters / 9 effects")

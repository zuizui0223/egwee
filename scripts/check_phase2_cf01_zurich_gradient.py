...
def main() -> None:
    ...
    assert set(registry) == {"ML015", PROGRAMME, "P2_CF01_MILKWEED_URBAN_2023", "P2_CF01_ACER_MIYABEI_2014", "P2_CF01_CARDIOPETALUM_2012"}
    ...
    print(
        ...
        "gradient_programmes=5 primary_Hedges_increment=0"
    )

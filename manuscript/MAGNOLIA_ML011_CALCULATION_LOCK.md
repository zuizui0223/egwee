# ML011 Magnolia calculation lock — frozen before supplement numeric rows
...
No numeric supplement row had been inspected when this calculation was frozen on the original recovery branch; this file preserves that prospective lock under the current ML011 identifier.
...
- all gates pass -> `ML011_admitted_C_F_covariance_aware`;

...
## Gradient-tier state-separation diagnostic

Within ML015, the strongest pairwise contrast is `I - F`:

- Fisher-z difference = `1.56622203`;
- SE = `0.46979298`;
- z = `3.33386`;
- two-sided p = `0.00085651`;
- Bonferroni cluster p across the three endpoint pairs = `0.00256953`.

This is retained as gradient/generalisation evidence only. It is not combined with the primary Hedges-g cluster p-values.
